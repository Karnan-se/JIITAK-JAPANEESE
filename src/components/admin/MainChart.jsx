  ...
  return (
    <>
      <main className="flex-1 ml-48 p-6">
        ...
        {/* Chart and Bottom Cards Container */}
        <div className="flex flex-col md:flex-row gap-4">
          {/* Gender-Age Chart */}
          <div className="bg-white p-4 rounded-sm shadow-sm mb-6 w-full md:w-1/2">
          ...
          <div className="w-full md:w-1/2 flex flex-col md:flex-row gap-6 h-36 ">
            {/* Draw Usage Count */}
            <div className="bg-white p-4 rounded-sm shadow-sm md:w-1/2 w-full">
